...
const profile = {
  name: "엄일경",
  summary:
    "프로덕트에 늘 진심인 3년차 웹개발자입니다. 사업 가치를 창출하는 것을 가장 중요하게 생각합니다. 동료들과 함께 주도적인 업무 진행을 할 수 있는 환경을 좋아합니다. A/B 테스트, TDD, 짝프로그래밍, 코드리뷰 문화가 있는 조직을 찾고 있습니다.",
...
const skillSet = {
  attitude: [
    ...
    "필요한 경우 낯선 분야도 적극적으로 학습하여 최적의 결과를 내도록 노력합니다.",
